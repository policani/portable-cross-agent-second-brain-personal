#!/usr/bin/env python3
"""Run the Memventory second-brain console locally with live reindexing."""
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Serve the Memventory second-brain console locally.")
    ...
    print(f"Memventory console: {url}")
